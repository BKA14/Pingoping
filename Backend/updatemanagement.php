...
$q = mysqli_query($con, "UPDATE `management_artiste` SET `prix` =' $prix',`lienphoto` =' $lienphoto',`commentaire1` =' $commentaire1',`commentaire2` =' $commentaire2',`commentaire3` =' $commentaire3'");
if($q){
