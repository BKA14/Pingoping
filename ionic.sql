...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 16 jan. 2024 à 15:15
...
(166, 4, 6, ' 62023367', ' non'),
(173, 1019, 6, ' 62023367', ' non'),
(175, 1021, 6, ' 62023367', ' non'),
(178, 1018, 6, ' 62023367', ' non'),
(179, 13, 6, ' 62023367', ' oui'),
(182, 0, 0, '', ''),
(183, 8, 6, '62023367', 'oui');
...
INSERT INTO `pub` (`titre`, `commentaire`, `photo`, `bouton`, `id`, `likes`, `contact`, `longitude`, `latitude`, `rangpub`) VALUES
('Command', ' ddddddddddddddddddddddddddddddddddd', 'http://localhost/imagepub/Ibrahim.jpg', 'rrrrrrrrrrr', 4, ' 2066', '+22662023367', '-1.3796', '12.6392', 1),
('Test', '    Ajouter ', 'https://docs-demo.ionic.io/assets/madison.jpg', 'https://docs-demo.ionic.io/assets/madison.jpg', 8, ' 2020', '', '-1.5197', '12.3714', 2),
('klk', '    hh', 'https://docs-demo.ionic.io/assets/madison.jpg', 'JJJJ', 13, ' 3', '33', '338', '888', 10000),
('Formation', 'HHHH', 'http://localhost/imagepub/Ibrahim.jpg', 'SS', 1018, ' 2', '', '', '', 0);
...
--
ALTER TABLE `pub`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1022;
...
--
ALTER TABLE `service`
  MODIFY `id` int(140) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1154;
